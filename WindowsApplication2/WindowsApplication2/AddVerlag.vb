...
Public Class AddVerlag
    ...
    Private Sub AddVerlag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            cmd.CommandText = "Insert Into Verlag values ('" & TextBox1.Text & "','" & TextBox2.Text & "')"
